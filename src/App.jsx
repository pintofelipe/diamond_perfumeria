  ...
  return (
    <div className="min-h-screen bg-[#1f1f1f] text-white flex flex-col relative">
      ...
      <div className="absolute bottom-0 w-full">
        ...
        <div className='absolute right-10 bottom-0 mb-35'>
        {isChatOpen && (
          <div className="mb-2">
            <ChatBoot />
          </div>
        ...
        <button
          ...
          className="bg-[#2b2b2b] text-black p-3 rounded-full shadow-lg hover:bg-[#b38224] transition hover:cursor-pointer"
        >
          {isChatOpen ? '✖️' : '💬'}
        </button>
        </div>
