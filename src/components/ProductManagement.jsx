      ...
      <div className="w-full max-w-6xl mx-auto text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-[#2a2a2a] p-6 rounded-lg shadow-[0_0_10px_2px_#facc15]">
            ...
            {message && <p className="mb-2 text-green-400 font-semibold">{message}</p>}
          ...
          <div className="bg-[#2a2a2a] p-6 rounded-lg shadow-[0_0_10px_2px_#facc15]">
            <h2 className="text-2xl font-bold mb-6 text-[#D49C2E]">Productos</h2>
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Precio: ${product.current_price} | Stock: {product.stock}
                    </p>
